...
CLASS lhc_travel IMPLEMENTATION.
  ...
  METHOD earlynumbering_create.
    ...
    DATA:
      entity           TYPE STRUCTURE FOR CREATE ZVKS001_R_TravelTP,
    ...
    ELSE.
      ...
      SELECT SINGLE FROM zvks001_a_travel FIELDS MAX( travel_id ) AS travelID INTO @travel_id_max.

      "Get max travel ID from draft table
      SELECT SINGLE FROM zvks001_d_travel FIELDS MAX( travelid ) INTO @DATA(max_travelid_draft).
  ...
  METHOD setStatusToOpen.
    ...
    READ ENTITIES OF ZVKS001_R_TravelTP IN LOCAL MODE
     ENTITY Travel
    ...
    MODIFY ENTITIES OF ZVKS001_R_TravelTP IN LOCAL MODE
      ENTITY Travel
        UPDATE SET FIELDS
